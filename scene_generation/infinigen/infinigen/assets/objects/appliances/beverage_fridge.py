...
class BeverageFridgeFactory(AssetFactory):
    ...
    def create_asset(self, **params):
        ...
        # OBJECT_CLASS_MAP key is "refrigerator" even though the in-scene class
        # is BeverageFridgeFactory — see TODO.md and the mapping in
        # infinigen/assets/sim_objects/mapping.py.
        from infinigen.core.sim.articulation_tagging import export_articulated_twin
        export_articulated_twin(obj, "refrigerator")
