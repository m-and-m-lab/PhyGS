...
def main(args):
    ...
    blend_paths = natsorted(glob('outputs/apartment-5-seq-tiny-25views-articulated_cabinets/*/*.blend'))
...
def make_args():
    ...
    parser.add_argument("-f", "--format", type=str, choices=FORMAT_CHOICES, default="usdc")
