...
Default robot-mounted depth cameras used by AO-Grasp and CuRobo:
...
Benchmark scripts wrap these existing prims with IsaacLab `CameraCfg` objects. They do not spawn replacement cameras.
